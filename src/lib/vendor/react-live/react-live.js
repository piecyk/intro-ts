(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('prismjs/components/prism-core'), require('prismjs/components/prism-clike'), require('prismjs/components/prism-javascript'), require('prismjs/components/prism-markup'), require('prismjs/components/prism-jsx'), require('unescape'), require('dom-iterator'), require('react'), require('prop-types')) :
	typeof define === 'function' && define.amd ? define(['exports', 'prismjs/components/prism-core', 'prismjs/components/prism-clike', 'prismjs/components/prism-javascript', 'prismjs/components/prism-markup', 'prismjs/components/prism-jsx', 'unescape', 'dom-iterator', 'react', 'prop-types'], factory) :
	(factory((global.ReactLive = {}),global.prismCore,null,null,null,null,global.unescape,global.iterator,global.React,global.PropTypes));
}(this, (function (exports,prismCore,prismClike,prismJavascript,prismMarkup,prismJsx,unescape,iterator,React,PropTypes) { 'use strict';
...
var evalCode = function evalCode(code, scope) {
  ...
  var res = new (Function.prototype.bind.apply(Function, [null].concat(['React'], scopeKeys, [code])))();
  return res.apply(undefined, [React__default].concat(scopeValues));
};
...
var generateElement = function generateElement(_ref, errorCallback) {
  ...
  return errorBoundary(evalCode('return ' + code, scope), errorCallback);
};
...
var renderElementAsync = function renderElementAsync(_ref2, resultCallback, errorCallback) {
  ...
  evalCode(code, _extends({}, scope, { render: render }));
};
